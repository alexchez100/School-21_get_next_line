...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/07/14 11:12:36 by gsansa            #+#    #+#             */
/*   Updated: 2020/07/14 12:05:09 by gsansa           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				get_next_line(int fd, char **line)
{
	...
	{
		buf[rd] = '\0';
		if (ft_strjoin_mod(&ost, &buf) == -1)
			return (-1);
		if ((res = ft_search_n(&ost, line)) != 0)
		{
			free(buf);
			return (res);
		}
